...
// 获取热门景区
export const getPopularSceneries = (limit = 5) =>
  request.get('/recommend/popular', { params: { type: 'scenery', limit } });

// 【新增】随机获取景区列表
export const getRandomSceneries = (limit = 6) =>
  request.get('/scenic/random', { params: { limit } });
